...
/** Generated Model for XX_ProductBudgetForm
 *  @author Jorg Janke (generated) 
 *  @version Release 3.8.10 - $Id: GenerateModel.java 10534 2012-10-05 09:30:50Z ragrawal $ */
public class X_XX_ProductBudgetForm extends PO
{
    /** Standard Constructor
    @param ctx context
    @param XX_ProductBudgetForm_ID id
    @param trx transaction
    */
    public X_XX_ProductBudgetForm (Ctx ctx, int XX_ProductBudgetForm_ID, Trx trx)
    {
        super (ctx, XX_ProductBudgetForm_ID, trx);
        
        /* The following are the mandatory fields for this object.
        
        if (XX_ProductBudgetForm_ID == 0)
        {
            setIsShowM (false);	// N
            setIsShowMQ (false);	// N
            setLine (0);	// @SQL=SELECT COALESCE(MAX(Line),0)+10 AS DefaultValue FROM XX_ProductBudgetForm WHERE XX_CustomerBudgetForm_ID = @XX_CustomerBudgetForm_ID@
            setXX_CustomerBudgetForm_ID (0);
            setXX_ProductBudgetForm_ID (0);
    ...
    @param trx transaction
    */
    public X_XX_ProductBudgetForm (Ctx ctx, ResultSet rs, Trx trx)
    {
        super (ctx, rs, trx);
        
    }
    /** Serial Version No */
    private static final long serialVersionUID = 27760213098494L;
    /** Last Updated Timestamp 2016-11-02 18:56:21.705 */
    public static final long updatedMS = 1478087781705L;
    /** AD_Table_ID=1000173 */
    public static final int Table_ID;
    
    static
    {
        Table_ID = get_Table_ID("XX_ProductBudgetForm");
        
    }
    ;
    
    /** TableName=XX_ProductBudgetForm */
    public static final String Table_Name="XX_ProductBudgetForm";
    ...
    /** Set Budget Product.
    @param XX_ProductBudgetForm_ID Budget Product */
    public void setXX_ProductBudgetForm_ID (int XX_ProductBudgetForm_ID)
    {
        if (XX_ProductBudgetForm_ID < 1) throw new IllegalArgumentException ("XX_ProductBudgetForm_ID is mandatory.");
        set_ValueNoCheck ("XX_ProductBudgetForm_ID", Integer.valueOf(XX_ProductBudgetForm_ID));
        
    }
    
    /** Get Budget Product.
    @return Budget Product */
    public int getXX_ProductBudgetForm_ID() 
    {
        return get_ValueAsInt("XX_ProductBudgetForm_ID");
