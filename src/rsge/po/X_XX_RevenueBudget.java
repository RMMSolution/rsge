...
/** Generated Model for XX_RevenueBudget
 *  @author Jorg Janke (generated) 
 *  @version Release 3.8.7 - $Id: GenerateModel.java 10534 2012-10-05 09:30:50Z ragrawal $ */
public class X_XX_RevenueBudget extends PO
{
    /** Standard Constructor
    @param ctx context
    @param XX_RevenueBudget_ID id
    @param trx transaction
    */
    public X_XX_RevenueBudget (Ctx ctx, int XX_RevenueBudget_ID, Trx trx)
    {
        super (ctx, XX_RevenueBudget_ID, trx);
        
        /* The following are the mandatory fields for this object.
        
        if (XX_RevenueBudget_ID == 0)
        {
    ...
    @param trx transaction
    */
    public X_XX_RevenueBudget (Ctx ctx, ResultSet rs, Trx trx)
    {
        super (ctx, rs, trx);
        
    }
    /** Serial Version No */
    private static final long serialVersionUID = 27728817590456L;
    /** Last Updated Timestamp 2015-11-05 09:57:53.667 */
    public static final long updatedMS = 1446692273667L;
    /** AD_Table_ID=1008779 */
    public static final int Table_ID;
    
    static
    {
        Table_ID = get_Table_ID("XX_RevenueBudget");
        
    }
    ;
    
    /** TableName=XX_RevenueBudget */
    public static final String Table_Name="XX_RevenueBudget";
    ...
    {
        throw new IllegalArgumentException ("XX_BudgetPlanning_ID is virtual column");
    ...
    public void setXX_RevenueBudget_ID (int XX_RevenueBudget_ID)
    {
        ...
        set_ValueNoCheck ("XX_RevenueBudget_ID", Integer.valueOf(XX_RevenueBudget_ID));
