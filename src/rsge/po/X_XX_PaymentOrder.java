...
/** Generated Model for XX_PaymentOrder
 *  @author Jorg Janke (generated) 
 *  @version Release 3.8.10 - $Id: GenerateModel.java 10534 2012-10-05 09:30:50Z ragrawal $ */
public class X_XX_PaymentOrder extends PO
{
    /** Standard Constructor
    @param ctx context
    @param XX_PaymentOrder_ID id
    @param trx transaction
    */
    public X_XX_PaymentOrder (Ctx ctx, int XX_PaymentOrder_ID, Trx trx)
    {
        super (ctx, XX_PaymentOrder_ID, trx);
        
        /* The following are the mandatory fields for this object.
        
        if (XX_PaymentOrder_ID == 0)
        {
    ...
    @param trx transaction
    */
    public X_XX_PaymentOrder (Ctx ctx, ResultSet rs, Trx trx)
    {
        super (ctx, rs, trx);
        
    }
    /** Serial Version No */
    private static final long serialVersionUID = 27704998279789L;
    /** Last Updated Timestamp 2015-02-02 17:29:23.0 */
    public static final long updatedMS = 1422872963000L;
    /** AD_Table_ID=1000167 */
    public static final int Table_ID;
    
    static
    {
        Table_ID = get_Table_ID("XX_PaymentOrder");
        
    }
    ;
    
    /** TableName=XX_PaymentOrder */
    public static final String Table_Name="XX_PaymentOrder";
    ...
    /** Set Payment Order.
    @param XX_PaymentOrder_ID Order to issue payment */
    public void setXX_PaymentOrder_ID (int XX_PaymentOrder_ID)
    {
        if (XX_PaymentOrder_ID < 1) throw new IllegalArgumentException ("XX_PaymentOrder_ID is mandatory.");
        set_ValueNoCheck ("XX_PaymentOrder_ID", Integer.valueOf(XX_PaymentOrder_ID));
        
    }
    
    /** Get Payment Order.
    @return Order to issue payment */
    public int getXX_PaymentOrder_ID() 
    {
        return get_ValueAsInt("XX_PaymentOrder_ID");
