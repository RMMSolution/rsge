...
/** Generated Model for XX_SummarySalesBudget
 *  @author Jorg Janke (generated) 
 *  @version Release 3.8.10 - $Id: GenerateModel.java 10534 2012-10-05 09:30:50Z ragrawal $ */
public class X_XX_SummarySalesBudget extends PO
{
    /** Standard Constructor
    @param ctx context
    @param XX_SummarySalesBudget_ID id
    @param trx transaction
    */
    public X_XX_SummarySalesBudget (Ctx ctx, int XX_SummarySalesBudget_ID, Trx trx)
    {
        super (ctx, XX_SummarySalesBudget_ID, trx);
        
        /* The following are the mandatory fields for this object.
        
        if (XX_SummarySalesBudget_ID == 0)
        {
            setIsShowM (false);	// N
            setIsShowMQ (false);	// N
            setLine (0);	// @SQL=SELECT COALESCE(MAX(Line),0)+10 AS DefaultValue FROM XX_SummarySalesBudget WHERE XX_SalesBudgetForm_ID = @XX_SalesBudgetForm_ID@
            setXX_SalesBudgetForm_ID (0);
            setXX_SummarySalesBudget_ID (0);
    ...
    @param trx transaction
    */
    public X_XX_SummarySalesBudget (Ctx ctx, ResultSet rs, Trx trx)
    {
        super (ctx, rs, trx);
        
    }
    /** Serial Version No */
    private static final long serialVersionUID = 27760213325119L;
    /** Last Updated Timestamp 2016-11-02 19:00:08.33 */
    public static final long updatedMS = 1478088008330L;
    /** AD_Table_ID=1000189 */
    public static final int Table_ID;
    
    static
    {
        Table_ID = get_Table_ID("XX_SummarySalesBudget");
        
    }
    ;
    
    /** TableName=XX_SummarySalesBudget */
    public static final String Table_Name="XX_SummarySalesBudget";
    ...
    /** Set Summary Sales.
    @param XX_SummarySalesBudget_ID Summary Sales */
    public void setXX_SummarySalesBudget_ID (int XX_SummarySalesBudget_ID)
    {
        if (XX_SummarySalesBudget_ID < 1) throw new IllegalArgumentException ("XX_SummarySalesBudget_ID is mandatory.");
        set_ValueNoCheck ("XX_SummarySalesBudget_ID", Integer.valueOf(XX_SummarySalesBudget_ID));
        
    }
    
    /** Get Summary Sales.
    @return Summary Sales */
    public int getXX_SummarySalesBudget_ID() 
    {
        return get_ValueAsInt("XX_SummarySalesBudget_ID");
