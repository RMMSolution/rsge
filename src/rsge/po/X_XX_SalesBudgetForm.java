...
/** Generated Model for XX_SalesBudgetForm
 *  @author Jorg Janke (generated) 
 *  @version Release 3.8.10 - $Id: GenerateModel.java 10534 2012-10-05 09:30:50Z ragrawal $ */
public class X_XX_SalesBudgetForm extends PO
{
    /** Standard Constructor
    @param ctx context
    @param XX_SalesBudgetForm_ID id
    @param trx transaction
    */
    public X_XX_SalesBudgetForm (Ctx ctx, int XX_SalesBudgetForm_ID, Trx trx)
    {
        super (ctx, XX_SalesBudgetForm_ID, trx);
        
        /* The following are the mandatory fields for this object.
        
        if (XX_SalesBudgetForm_ID == 0)
        {
    ...
    @param trx transaction
    */
    public X_XX_SalesBudgetForm (Ctx ctx, ResultSet rs, Trx trx)
    {
        super (ctx, rs, trx);
        
    }
    /** Serial Version No */
    private static final long serialVersionUID = 27760216301185L;
    /** Last Updated Timestamp 2016-11-02 19:49:44.396 */
    public static final long updatedMS = 1478090984396L;
    /** AD_Table_ID=1000185 */
    public static final int Table_ID;
    
    static
    {
        Table_ID = get_Table_ID("XX_SalesBudgetForm");
        
    }
    ;
    
    /** TableName=XX_SalesBudgetForm */
    public static final String Table_Name="XX_SalesBudgetForm";
    ...
    public void setXX_SalesBudgetForm_ID (int XX_SalesBudgetForm_ID)
    {
        ...
        set_ValueNoCheck ("XX_SalesBudgetForm_ID", Integer.valueOf(XX_SalesBudgetForm_ID));
