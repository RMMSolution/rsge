...
/** Generated Model for XX_ARLine
 *  @author Jorg Janke (generated) 
 *  @version Release 3.8.7 - $Id: GenerateModel.java 10534 2012-10-05 09:30:50Z ragrawal $ */
public class X_XX_ARLine extends PO
{
    /** Standard Constructor
    @param ctx context
    @param XX_ARLine_ID id
    @param trx transaction
    */
    public X_XX_ARLine (Ctx ctx, int XX_ARLine_ID, Trx trx)
    {
        super (ctx, XX_ARLine_ID, trx);
    ...
    @param trx transaction
    */
    public X_XX_ARLine (Ctx ctx, ResultSet rs, Trx trx)
    {
        super (ctx, rs, trx);
        
    }
    /** Serial Version No */
    private static final long serialVersionUID = 27673756744789L;
    /** Last Updated Timestamp 2014-02-06 03:17:08.0 */
    public static final long updatedMS = 1391631428000L;
    /** AD_Table_ID=1000513 */
    public static final int Table_ID;
    
    static
    {
        Table_ID = get_Table_ID("XX_ARLine");
        
    }
    ;
    
    /** TableName=XX_ARLine */
    public static final String Table_Name="XX_ARLine";
    ...
    @param XX_ARLine_ID Account Receivable */
    public void setXX_ARLine_ID (int XX_ARLine_ID)
    {
        if (XX_ARLine_ID < 1) throw new IllegalArgumentException ("XX_ARLine_ID is mandatory.");
        set_ValueNoCheck ("XX_ARLine_ID", Integer.valueOf(XX_ARLine_ID));
        
    }
    
    /** Get Account Receivable.
    @return Account Receivable */
    public int getXX_ARLine_ID() 
    {
        return get_ValueAsInt("XX_ARLine_ID");
