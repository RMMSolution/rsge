...
/** Generated Model for XX_SubsidiaryCompanyAcct
 *  @author Jorg Janke (generated) 
 *  @version Release 3.8.7 - $Id: GenerateModel.java 10534 2012-10-05 09:30:50Z ragrawal $ */
public class X_XX_SubsidiaryCompanyAcct extends PO
{
    /** Standard Constructor
    @param ctx context
    @param XX_SubsidiaryCompanyAcct_ID id
    @param trx transaction
    */
    public X_XX_SubsidiaryCompanyAcct (Ctx ctx, int XX_SubsidiaryCompanyAcct_ID, Trx trx)
    {
        super (ctx, XX_SubsidiaryCompanyAcct_ID, trx);
        
        /* The following are the mandatory fields for this object.
        
        if (XX_SubsidiaryCompanyAcct_ID == 0)
        {
    ...
    @param trx transaction
    */
    public X_XX_SubsidiaryCompanyAcct (Ctx ctx, ResultSet rs, Trx trx)
    {
        super (ctx, rs, trx);
        
    }
    /** Serial Version No */
    private static final long serialVersionUID = 27778071972851L;
    /** Last Updated Timestamp 2017-05-28 11:44:16.062 */
    public static final long updatedMS = 1495946656062L;
    /** AD_Table_ID=1014495 */
    public static final int Table_ID;
    
    static
    {
        Table_ID = get_Table_ID("XX_SubsidiaryCompanyAcct");
        
    }
    ;
    
    /** TableName=XX_SubsidiaryCompanyAcct */
    public static final String Table_Name="XX_SubsidiaryCompanyAcct";
    ...
    /** Set System Client.
    @param XX_SystemClient_ID System Client */
