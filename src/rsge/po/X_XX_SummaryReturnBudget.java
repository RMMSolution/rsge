...
/** Generated Model for XX_SummaryReturnBudget
 *  @author Jorg Janke (generated) 
 *  @version Release 3.8.10 - $Id: GenerateModel.java 10534 2012-10-05 09:30:50Z ragrawal $ */
public class X_XX_SummaryReturnBudget extends PO
{
    /** Standard Constructor
    @param ctx context
    @param XX_SummaryReturnBudget_ID id
    @param trx transaction
    */
    public X_XX_SummaryReturnBudget (Ctx ctx, int XX_SummaryReturnBudget_ID, Trx trx)
    {
        super (ctx, XX_SummaryReturnBudget_ID, trx);
        
        /* The following are the mandatory fields for this object.
        
        if (XX_SummaryReturnBudget_ID == 0)
        {
            setIsShowM (false);	// N
            setIsShowMQ (false);	// N
            setLine (0);	// @SQL=SELECT COALESCE(MAX(Line),0)+10 AS DefaultValue FROM XX_SummaryReturnBudget WHERE XX_SalesBudgetForm_ID = @XX_SalesBudgetForm_ID@
            setXX_SalesBudgetForm_ID (0);
            setXX_SummaryReturnBudget_ID (0);
    ...
    @param trx transaction
    */
    public X_XX_SummaryReturnBudget (Ctx ctx, ResultSet rs, Trx trx)
    {
        super (ctx, rs, trx);
        
    }
    /** Serial Version No */
    private static final long serialVersionUID = 27760213247499L;
    /** Last Updated Timestamp 2016-11-02 18:58:50.71 */
    public static final long updatedMS = 1478087930710L;
    /** AD_Table_ID=1000188 */
    public static final int Table_ID;
    
    static
    {
        Table_ID = get_Table_ID("XX_SummaryReturnBudget");
        
    }
    ;
    
    /** TableName=XX_SummaryReturnBudget */
    public static final String Table_Name="XX_SummaryReturnBudget";
    ...
    /** Set Summary Return.
    @param XX_SummaryReturnBudget_ID Summary Return */
    public void setXX_SummaryReturnBudget_ID (int XX_SummaryReturnBudget_ID)
    {
        if (XX_SummaryReturnBudget_ID < 1) throw new IllegalArgumentException ("XX_SummaryReturnBudget_ID is mandatory.");
        set_ValueNoCheck ("XX_SummaryReturnBudget_ID", Integer.valueOf(XX_SummaryReturnBudget_ID));
        
    }
    
    /** Get Summary Return.
    @return Summary Return */
    public int getXX_SummaryReturnBudget_ID() 
    {
        return get_ValueAsInt("XX_SummaryReturnBudget_ID");
