...
/** Generated Model for XX_NonItemAllocation
 *  @author Jorg Janke (generated) 
 *  @version Release 3.8.10 - $Id: GenerateModel.java 10534 2012-10-05 09:30:50Z ragrawal $ */
public class X_XX_NonItemAllocation extends PO
{
    /** Standard Constructor
    @param ctx context
    @param XX_NonItemAllocation_ID id
    @param trx transaction
    */
    public X_XX_NonItemAllocation (Ctx ctx, int XX_NonItemAllocation_ID, Trx trx)
    {
        super (ctx, XX_NonItemAllocation_ID, trx);
        
        /* The following are the mandatory fields for this object.
        
        if (XX_NonItemAllocation_ID == 0)
        {
            setDocumentNo (null);
            setM_Product_ID (0);
    ...
    @param trx transaction
    */
    public X_XX_NonItemAllocation (Ctx ctx, ResultSet rs, Trx trx)
    {
        super (ctx, rs, trx);
        
    }
    /** Serial Version No */
    private static final long serialVersionUID = 27801696869038L;
    /** Last Updated Timestamp 2018-02-25 22:12:32.249 */
    public static final long updatedMS = 1519571552249L;
    /** AD_Table_ID=1000202 */
    public static final int Table_ID;
    
    static
    {
        Table_ID = get_Table_ID("XX_NonItemAllocation");
        
    }
    ;
    
    /** TableName=XX_NonItemAllocation */
    public static final String Table_Name="XX_NonItemAllocation";
    ...
    public void setXX_NonItemAllocation_ID (int XX_NonItemAllocation_ID)
    {
        ...
        set_ValueNoCheck ("XX_NonItemAllocation_ID", Integer.valueOf(XX_NonItemAllocation_ID));
