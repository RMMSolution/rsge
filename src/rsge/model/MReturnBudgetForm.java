...
import rsge.po.X_XX_ReturnBudgetForm;

/**
 * @author bang
 * 
 */
public class MReturnBudgetForm extends X_XX_ReturnBudgetForm {
	...
	private static final org.compiere.util.CLogger log = org.compiere.util.CLogger
			.getCLogger(MReturnBudgetForm.class);

	/**
	 * @param ctx
	 * @param XX_ReturnBudgetForm_ID
	 * @param trx
	 */
	public MReturnBudgetForm(Ctx ctx, int XX_ReturnBudgetForm_ID, Trx trx) {
	 ...
	 * @param trx
	 */
	public MReturnBudgetForm(Ctx ctx, ResultSet rs, Trx trx) {
		super(ctx, rs, trx);
		// TODO Auto-generated constructor stub
	}
