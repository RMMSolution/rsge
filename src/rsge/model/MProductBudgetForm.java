...
import rsge.po.X_XX_ProductBudgetForm;

/**
 * @author bang
 * 
 */
public class MProductBudgetForm extends X_XX_ProductBudgetForm {
	...
	private static final org.compiere.util.CLogger log = org.compiere.util.CLogger
			.getCLogger(MProductBudgetForm.class);

	/**
	 * @param ctx
	 * @param XX_ProductBudgetForm_ID
	 * @param trx
	 */
	public MProductBudgetForm(Ctx ctx, int XX_ProductBudgetForm_ID, Trx trx) {
	 ...
	 * @param trx
	 */
	public MProductBudgetForm(Ctx ctx, ResultSet rs, Trx trx) {
		super(ctx, rs, trx);
		// TODO Auto-generated constructor stub
	}
