 ...
 */
public class MInvoiceTax extends org.compiere.model.MInvoiceTax

{
	 ...
	 */
	public boolean calculateTaxFromLines (BigDecimal serviceChargeAmt, BigDecimal invoiceDiscAmt)
	{
		...
		// Add Service Charge to Tax Base Amt if any
		...
		System.out.println("Initial Tax Base Amt " + taxBaseAmt);
		System.out.println("Service Charge Amt " + serviceChargeAmt);
		taxBaseAmt = taxBaseAmt.add(serviceChargeAmt);
		
		// Deduct Invoice discount if any
		System.out.println("Invoice Discount " + invoiceDiscAmt);
		if(invoiceDiscAmt==null)
			invoiceDiscAmt = invoice.getInvoiceDiscAmt();
		if(invoice.getInvoiceDiscAmt().signum()!=0)
		{
			System.out.println("Tax Base Start " + taxBaseAmt);
			taxBaseAmt = taxBaseAmt.subtract(invoiceDiscAmt);
			System.out.println("Discount " + invoiceDiscAmt);
			System.out.println("Tax Base Final " + taxBaseAmt);
		}
