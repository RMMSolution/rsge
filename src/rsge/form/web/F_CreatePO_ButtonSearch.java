 ...
 *
 */
public class F_CreatePO_ButtonSearch implements ComponentImplIntf{

	/**
	 * 
	 */
	public F_CreatePO_ButtonSearch() {
	...
	public ComponentVO getComponentVO() {
		...
		//Field Button Search
		FieldVO fVO_BtnCompleted = new FieldVO("bSearch", "Search", DisplayTypeConstants.Button, false);
