 ...
 *
 */
public class ProductCategoryAcctCopyRSGE extends SvrProcess {
	...
	protected String doIt() throws Exception {
		// Update
		StringBuilder update = new StringBuilder("UPDATE M_Product_Acct " +
		...
		update.append("WHERE M_Product_ID IN (SELECT M_Product_ID FROM M_Product WHERE M_Product_Category_ID = ?) " +
				"AND C_AcctSchema_ID = ? ");

		DB.executeUpdate(get_Trx(), update.toString(), p_UseProductReturn, p_SalesReturnAcct, p_M_Product_Category_ID, p_C_AcctSchema_ID);
