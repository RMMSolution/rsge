...
public class MReportColumn extends X_PA_ReportColumn
{
    ...
    /** Set End of Year.
    @param IsEndOfYear Override end date of this column to end of year */
    public void setIsEndOfYear (boolean IsEndOfYear)
    {
        set_Value ("IsEndOfYear", Boolean.valueOf(IsEndOfYear));
        
    }
    
    /** Get End of Year.
    @return Override end date of this column to end of year */
    public boolean isEndOfYear() 
    {
        return get_ValueAsBoolean("IsEndOfYear");
        
    }

    /** Set Recorded Column.
    @param IsRecordedColumn Indicate this column is use to update annual financial record */
    public void setIsRecordedColumn (boolean IsRecordedColumn)
    {
        set_Value ("IsRecordedColumn", Boolean.valueOf(IsRecordedColumn));
        
    }
    
    /** Get Recorded Column.
    @return Indicate this column is use to update annual financial record */
    public boolean isRecordedColumn() 
    {
        return get_ValueAsBoolean("IsRecordedColumn");
