...
public class AmtInWords_IN implements AmtInWords
{
  ...
  * @param currency - null if no currency to be said
  * @return said number
  */
  public static String sayNumber(double number, String currency) {
  ...
  throws IllegalArgumentException {
   ...
   static void saySimpleNumber(StringBuffer appendTo, int number) {
	 ...
	 */
	public String getAmtInWords (String amount, String currency) throws Exception
	{
		if (amount == null)
			return amount;
		//
	...
	private void print (String amt)
	{
		...
		try
		{
			System.out.println(amt + " = " + getAmtInWords(amt, currency));
		}
		catch (Exception e)
		{
			e.printStackTrace();
